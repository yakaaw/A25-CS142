...
const ProfileSettings: React.FC = () => {
    ...
    const [signatureUrl, setSignatureUrl] = useState(userProfile?.signatureUrl || '');
    ...
    const hasApprovalAuthority = ['pic_gudang', 'direksi', 'admin'].includes(userProfile?.role || '');
        ...
        <Box>
            <PageHeader
                ...
                breadcrumbs={[
                    ...
                    { label: 'Pengaturan Profil', to: '/settings/profile' },
                ]}
            />
                        ...
                        <CardContent sx={{ p: 4 }}>
                            ...
                            <Stack direction={{ xs: 'column', md: 'row' }} spacing={4} alignItems={{ xs: 'center', md: 'flex-start' }}>
                                ...
                                <Box sx={{ textAlign: 'center' }}>
                                    ...
                                    >
                                        {!userProfile?.photoURL && (userProfile?.name?.charAt(0).toUpperCase() || userProfile?.email?.charAt(0).toUpperCase() || 'U')}
                                    </Avatar>
                                        ...
                                        <Stack direction={{ xs: 'column', sm: 'row' }} spacing={3}>
                                            <Stack direction="row" spacing={1} alignItems="center" sx={{ flex: 1 }}>
                                                ...
                                                <Box>
                                                    ...
                                                    <Typography variant="body2" fontWeight={600}>
                                                        {userProfile?.createdAt ? new Date(userProfile.createdAt).toLocaleDateString('id-ID') : '-'}
                                                    </Typography>
                                                </Box>
                                            </Stack>
                        ...
                        <Card elevation={2}>
                            <CardContent sx={{ p: 4 }}>
                                ...
                                <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
                                    Upload tanda tangan untuk approval otomatis pada dokumen BAPB dan BAPP
                                </Typography>
                                ...
                                {userProfile?.signatureUrl ? (
                                    ...
                                    <Alert severity="warning" sx={{ mb: 3 }}>
                                        Belum ada tanda tangan. Upload tanda tangan Anda untuk approval otomatis.
                                    </Alert>
                                )}
                                ...
                                <SignatureUpload
                                    ...
                                    onUploadComplete={(base64) => {
                                        ...
                                        showToast('Tanda tangan berhasil diupload. Klik Simpan untuk menyimpan perubahan.', 'success');
                                    }}
                                />

                                <Button
                                    variant="contained"
                                    disabled={loadingProfile || signatureUrl === userProfile?.signatureUrl}
